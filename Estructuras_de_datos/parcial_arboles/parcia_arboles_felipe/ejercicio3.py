...
def invertir_arbol_binario(root_node):
  if root_node is None:
    return
  if root_node.leftchild is not None:

    temporal_child = root_node.leftchild
    root_node.leftchild = root_node.rightchild
    root_node.rightchild = temporal_child

  invertir_arbol_binario(root_node.leftchild)
  invertir_arbol_binario(root_node.rightchild)
  
  return root_node

tree = binarytree(4)
insertNode(tree, binarytree(2))
insertNode(tree, binarytree(7))
insertNode(tree, binarytree(1))
insertNode(tree, binarytree(3))
insertNode(tree, binarytree(6))
insertNode(tree, binarytree(9))
print("Original tree")
printTree(tree)
print("-------------------------")
print("Arbol invertido")
printTree(invertir_arbol_binario(tree))
